...
let headers = ["nombre"; "min_peso"; "max_peso"; "kg_adicional";
               "precio_normal"; "precio_mismo_dia"; "tipo_vehiculo";
               "hub"; "region_origen"; "region_destino"; "zona"; "tipo"]
...
let getFromMap map =
  (get_key "zona" map, get_key "hub" map, get_key "precio_normal" map |> int_of_string)
